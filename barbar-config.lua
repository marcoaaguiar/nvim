...
vim.api.nvim_set_keymap('n', '<C-s>', ':BufferPick<CR>', {noremap = true})
...
vim.api.nvim_set_keymap('n', '<A-9>', ':BufferLast<CR>', {noremap = true})
-- Close buffer
vim.api.nvim_set_keymap('n', '<A-c>', ':BufferClose<CR>', {noremap = true})
vim.api.nvim_set_keymap('n', '<A-p>', ':BufferPin<CR>', {noremap = true})
